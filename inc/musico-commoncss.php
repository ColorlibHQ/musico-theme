...
// enqueue css
function musico_common_custom_css(){
    
    wp_enqueue_style( 'musico-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= musico_opt( 'musico_theme_color' ) != '#131313' ? musico_opt( 'musico_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= musico_opt( 'musico_book_btn_color' ) != '#131313' ? musico_opt('musico_book_btn_color') : '';
		$bookBtnHoverBgColor     	= musico_opt( 'musico_book_btn_hvr_bg_color' ) != '#131313' ? musico_opt('musico_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = musico_opt( 'musico_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = musico_opt( 'musico_navbar_bg_color' ) != '#082b49' ? musico_opt( 'musico_navbar_bg_color') : '';
		$headerTop_col     		  = musico_opt( 'musico_top_header_color' );

		$headerTopBg      		  = musico_opt( 'musico_top_header_bg_color');
		$headerBg          		  = musico_opt( 'musico_header_bg_color') != '#ffffff' ? musico_opt( 'musico_header_bg_color') : '';
		$menuColor          	  = musico_opt( 'musico_header_menu_color' ) != '#131313' ? musico_opt('musico_header_menu_color') : '';
		$menuHoverColor           = musico_opt( 'musico_header_menu_hover_color' ) != '#808080' ? musico_opt('musico_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = musico_opt( 'musico_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = musico_opt( 'musico_header_drop_menu_bg_color' ) != '#ffffff' ? musico_opt('musico_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = musico_opt( 'musico_dropdown_menu_color' ) != '#131313' ? musico_opt('musico_dropdown_menu_color') : '';
		$dropMenuHovColor         = musico_opt( 'musico_dropdown_menu_hover_color' ) != '#808080' ? musico_opt('musico_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = musico_opt( 'musico_footer_widget_bg_color' );
		$footerwHeadColor   	  = musico_opt('musico_footer_widget_heading_color');
		$footerwTextColor   	  = musico_opt('musico_footer_widget_text_color');
		$footerwanchorcolor 	  = musico_opt('musico_footer_widget_anchor_color') != '#ffffff' ? musico_opt('musico_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = musico_opt('musico_footer_widget_anchor_hover_color') != '#ffffff' ? musico_opt('musico_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = musico_opt('musico_fof_bg_color');
		$foftonecolor			  = musico_opt('musico_fof_textone_color');
		$fofttwocolor			  = musico_opt('musico_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = musico_opt('musico_footer_widget_anchor_color') != '#9e9e9e' ? musico_opt('musico_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .musico_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .musico_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'musico-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'musico_common_custom_css', 50 );