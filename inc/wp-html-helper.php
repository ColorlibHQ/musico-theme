...
// image default alt
if ( ! function_exists( 'musico_img_default_alt' ) ) {
	function musico_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'musico_img_tag' ) ) {
	function musico_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = musico_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'musico_anchor_tag' ) ) {
	function musico_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'musico_heading_tag' ) ) {
	function musico_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'musico_paragraph_tag' ) ) {
	function musico_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'musico_other_tag' ) ) {
	function musico_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'musico_button_element ' ) ) {
	function musico_button_element( array $args ) {
